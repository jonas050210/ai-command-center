...
export const CodeIcon = I('<path d="m8 8-4 4 4 4M16 8l4 4-4 4M13 5l-2 14"/>');
export const FileIcon = I('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/>');
